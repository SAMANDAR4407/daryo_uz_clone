import 'package:daryo_uz_clone/pages/news_detail_page.dart';
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Image.asset('assets/images/post3.png', fit: BoxFit.cover, width: double.infinity,),
                    Padding(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Image.asset('assets/images/pod1.png', fit: BoxFit.cover, width: double.infinity,),
                    Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 17, vertical: 15),
                        child: Row(
                          children: [
